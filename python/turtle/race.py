...
def print_winner(winner):
    ...
    color('red')
    goto(0, -100)
    write(f"{fg.capitalize()} Finished First", align = 'center', font = ('Arial', 20, 'normal'))
...
# this is appromixately the finish line
winning_xpos = 150
...
while True:
    ...
    if player_1.xcor() > winning_xpos:
        print_winner(player_1)
        break;
    elif player_2.xcor() > winning_xpos:
        print_winner(player_2)
        break;
    elif player_3.xcor() > winning_xpos:
        print_winner(player_3)
        break;
    elif player_4.xcor() > winning_xpos:
